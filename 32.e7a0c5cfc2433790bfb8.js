...
const {groupEntries, parseData} = __webpack_require__(2831);

const {resolveBlockTimes, resolveAssets} = __webpack_require__(2833);

const {getAccountHistoryES, getAccountHistory} =
    __webpack_require__(2835)(true);
...
module.exports = function (isBrowser) {
    if (isBrowser) fetchClient = fetch;
        ...
        fetchClient = __webpack_require__(2836);
    }
...
const config = __webpack_require__(2834);
...
const utils = __webpack_require__(2832);
