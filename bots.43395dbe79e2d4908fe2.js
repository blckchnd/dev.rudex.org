...
var PercentUp = function () {
    function PercentUp(account, storage, initData) {
        ...
        this.checkOrders = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
            var state, log, accountBalances, balance, amount, orders, processOrders, orderFee, promises, lowPrice, orderBook, quoteAmount, baseAmount, i, ask, quote, base, diffBase, price, isGreaterDistance, baseAssetAmount, quoteAssetAmount, obj, order;
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                        ...
                        case 57:
                            price = quoteAmount.div(baseAmount), isGreaterDistance = !!lowPrice && lowPrice.minus(price).abs().div(lowPrice).times(100).isGreaterThan(state.distance);
