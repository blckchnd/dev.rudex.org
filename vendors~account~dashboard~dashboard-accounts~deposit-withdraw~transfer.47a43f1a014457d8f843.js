...
var moment = __webpack_require__(1352);
...
var config = __webpack_require__(2570);
...
module.exports = function(isBrowser) {
    if (isBrowser) fetchClient = fetch;
        ...
        fetchClient = __webpack_require__(2572);
    }
