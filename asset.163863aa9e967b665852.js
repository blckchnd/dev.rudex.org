...
/* harmony import */ var _Utility_FormattedAsset__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1010);
/* harmony import */ var _Utility_FormattedPrice__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1336);
/* harmony import */ var _Utility_AssetImage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(2410);
/* harmony import */ var _Utility_AssetName__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1220);
/* harmony import */ var _Utility_TimeAgo__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(1383);
/* harmony import */ var _Utility_HelpContent__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(1054);
/* harmony import */ var common_asset_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(1033);
/* harmony import */ var common_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(568);
/* harmony import */ var _Utility_FormattedTime__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(2725);
...
/* harmony import */ var _Utility_Tabs__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(2471);
/* harmony import */ var common_MarketClasses__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(581);
/* harmony import */ var _Page404_Page404__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(2348);
/* harmony import */ var _Account_FundFeePool__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(2499);
/* harmony import */ var stores_AccountStore__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(550);
/* harmony import */ var alt_react__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(787);
...
var Asset = function (_React$Component3) {
    ...
    _createClass(Asset, [{
        ...
        value: function renderAboutBox(asset, originalAsset) {
            var issuer = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_14__["ChainStore"].getObject(asset.issuer, false, false);
            ...
            // Add market link
            var core_asset = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_14__["ChainStore"].getAsset("1.3.0");
            ...
            if ("bitasset" in asset && asset.bitasset.is_prediction_market) {
                preferredMarket = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_14__["ChainStore"].getAsset(asset.bitasset.options.short_backing_asset);
                if (preferredMarket) {
        ...
        value: function getMarginPositions() {
            ...
            var sortFunctions = {
                name: function name(a, b) {
                    var nameA = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_14__["ChainStore"].getAccount(a.borrower, false);
                    if (nameA) nameA = nameA.get("name");
                    var nameB = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_14__["ChainStore"].getAccount(b.borrower, false);
