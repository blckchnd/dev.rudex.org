...
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony import */ var lodash_es_isNaN__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1004);
/* harmony import */ var lodash_es_debounce__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1006);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(384);
...
/* harmony import */ var _Forms_AccountSelect__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1008);
...
/* harmony import */ var _Utility_AmountSelector__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(1009);
...
/* harmony import */ var _Account_RecentTransactions__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(2510);
...
/* harmony import */ var bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(417);
...
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(868);
...
/* harmony import */ var common_MarketClasses__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(581);
/* harmony import */ var query_string__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(2535);
...
var Transfer = function (_React$Component) {
    ...
    function Transfer(props) {
        ...
        if (query.from) {
            ...
            bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getAccount(query.from);
        }
        if (query.to) {
            state.to_name = query.to;
            bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getAccount(query.to);
        }
        if (query.amount) state.amount = query.amount;
        if (query.asset) {
            state.asset_id = query.asset;
            state.asset = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getAsset(query.asset);
        }
    ...
    _createClass(Transfer, [{
        ...
        value: function shouldComponentUpdate(np, ns) {
            ...
            if (next_asset_types.length === 1) {
                var asset = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getAsset(next_asset_types[0]);
        ...
        value: function componentWillReceiveProps(np) {
            ...
            if (np.currentAccount !== this.state.from_name && np.currentAccount !== this.props.currentAccount) {
                this.setState({
                    ...
                    from_account: bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getAccount(np.currentAccount),
                    feeStatus: {},
                    fee_asset_id: "1.3.0",
                    feeAmount: new common_MarketClasses__WEBPACK_IMPORTED_MODULE_19__["Asset"]({ amount: 0 })
                }, function () {
                    _this2._updateFee();
                    _this2._checkFeeStatus(bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getAccount(np.currentAccount));
                });
            }
        }
    }, {
        ...
        value: function _checkBalance() {
            ...
            var balanceObject = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getObject(balanceID);
            var feeBalanceObject = feeBalanceID ? bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getObject(feeBalanceID) : null;
        ...
        value: function _setTotal(asset_id, balance_id) {
            ...
            var balanceObject = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getObject(balance_id);
            var transferAsset = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getObject(asset_id);
        ...
        value: function _getAvailableAssets() {
            ...
            for (var key in account_balances) {
                var balanceObject = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getObject(account_balances[key]);
        ...
        value: function render() {
            ...
            if (from_account && from_account.get("balances") && !from_error) {
                ...
                if (asset_types.length === 1) asset = bitsharesjs_es__WEBPACK_IMPORTED_MODULE_15__["ChainStore"].getAsset(asset_types[0]);
...
const strictUriEncode = __webpack_require__(2536);
const decodeComponent = __webpack_require__(2537);
