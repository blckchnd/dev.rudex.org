...
var config = __webpack_require__(2558);
...
module.exports = function(isBrowser) {
    if (isBrowser) fetchClient = fetch;
        ...
        fetchClient = __webpack_require__(2560);
    }
