...
var utils = __webpack_require__(2802);
...
module.exports = function(isBrowser) {
    if (isBrowser) fetchClient = fetch;
        ...
        fetchClient = __webpack_require__(2806);
    }
