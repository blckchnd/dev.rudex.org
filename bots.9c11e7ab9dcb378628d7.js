                ...
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 11:
                            ...
                            console.log("account", _this.account, balance, amount);
                                    ...
                                    return regeneratorRuntime.wrap(function _callee$(_context) {
                                        while (1) {
                                            switch (_context.prev = _context.next) {
                                                ...
                                                case 5:
                                                    _price = Object(bignumber_js__WEBPACK_IMPORTED_MODULE_6__["default"])(order.quote).div(order.base).times(1 - Number(state.spread) / 100);


                                                    log("buy: " + _price.toNumber() + " " + _this.base.symbol + "/" + _this.quote.symbol);
                                                    _context.next = 9;
                                                    return _this.account.sell(_this.quote.symbol, _this.base.symbol, Math.min(accountBalances.quote, state.quote), Object(bignumber_js__WEBPACK_IMPORTED_MODULE_6__["default"])(1).div(_price).toNumber());
                        ...
                        case 23:
                            ...
                            log("[" + state.name + "] Orders exists: " + !!lowPrice + ", balance > amount: " + (balance > amount) + ", lowPrice - price > distance: " + (!!lowPrice && lowPrice.times(1 - Number(state.distance) / 100).isGreaterThan(price)));
